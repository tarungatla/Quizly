...
const QuizResult = ({ result, quiz, totalQuestions, onNavigate }) => {
  ...
  const percentage = (
    (displayData.result.marksGot / displayData.quiz.maxMarks) *
    100
  ).toFixed(1);
  const isPassed = percentage >= 50;
  const correctPercentage = (
    (displayData.result.correctAnswers / displayData.totalQuestions) *
    100
  ).toFixed(1);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-100 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div
                className={`inline-flex items-center px-4 py-2 rounded-full ${gradeInfo.bg} ${gradeInfo.color} bg-opacity-20 text-white font-semibold`}
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center transform hover:scale-105 transition-transform">
            ...
            <div className="text-sm text-blue-600">
              out of {displayData.quiz?.maxMarks}
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center transform hover:scale-105 transition-transform">
            ...
            <div className="text-sm text-green-600">
              out of {displayData.totalQuestions}
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <button
            onClick={() => {
              // navigate(`/quiz/${displayData.quiz?.qId}`);
